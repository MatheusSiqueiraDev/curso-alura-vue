    ...
    <div>
        ...
        <form v-on:submit.prevent="grava()">
            ...
            <div class="controle">
                ...
                <imagem-responsiva v-show="foto.url" v-bind:url="foto.url" v-bind:titulo="foto.titulo"/>
            </div>
...
export default {
    ...
    methods: {
        grava() {
            ...
            /*
            this.resource.save(this.foto).then(() => this.foto = new Foto(), err => console.log(err));
